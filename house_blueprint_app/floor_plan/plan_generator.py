...
def generate_floor_plan(house_data):
    ...
    # Room dimensions (adjustable for square shape)
    ...
    grid_spacing = 2  # Space between rooms to avoid overlap

    # Define a strict grid-based layout
    grid_size = int(width // base_size)  # Create a structured grid
    center_x, center_y = grid_size // 2, grid_size // 2
    grid_positions = {(center_x, center_y): "living room"}

    occupied_positions = set()
    occupied_positions.add((center_x, center_y))
    ...
    print("Room list after shuffling:", room_list)
