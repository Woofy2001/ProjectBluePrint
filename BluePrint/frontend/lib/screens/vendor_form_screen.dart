...
class _VendorFormScreenState extends State<VendorFormScreen> {
  ...
  Future<String> _uploadImage(File imageFile, String vendorId) async {
    try {
      Reference ref =
          FirebaseStorage.instance.ref().child("vendors/$vendorId.jpg");
  ...
  Future<void> _submitForm() async {
    ...
    Map<String, dynamic> vendorData = {
      ...
      "services": services,
      "latitude": _locationEnabled && _currentPosition != null
          ? _currentPosition!.latitude
          : null,
      "longitude": _locationEnabled && _currentPosition != null
        ...
        child: Column(
          children: [
            _image != null
                ...
                : CircleAvatar(child: Icon(Icons.camera_alt), radius: 50),
